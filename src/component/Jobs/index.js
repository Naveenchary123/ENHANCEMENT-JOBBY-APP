...
class Jobs extends Component {
  ...
  changeLocation = event => {
    this.setState({jobLocation: event.target.value}, this.getJobsDetails)
  }
      ...
      <>
        ...
        <div className="jobs-container">
          ...
          <div>
            ...
            <ul className="filter-type-list">
              {jobLocationList.map(eachLocation => (
                <li className="filter-item" key={eachLocation.jobLocationId}>
                  <input
                    onChange={this.changeLocation}
                    id={eachLocation.jobLocationId}
                    type="radio"
                    name="location"
                    value={eachLocation.jobLocationId}
                  />
                  <label
                    className="filter-type-label"
                    htmlFor={eachLocation.jobLocationId}
                  >
                    {eachLocation.label}
                  </label>
                </li>
